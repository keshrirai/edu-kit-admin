...
class AdmissionEnquiry extends Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(dashboardActions.getAdmissionEnqList(data));
  }
  ...
  deleteUser = (data) => {
    ...
    confirmAlert({
      ...
      buttons: [
        {
          label: 'Yes',
          onClick: () => this.props.dispatch(dashboardActions.deleteAdmissionEnq(datatemp))
        },
        {
          label: 'No'
        }
  ...
  render() {
    ...
    let { getAdmissionEnqList } = dashboard;
    ...
    console.log('getAdmissionEnqListgetAdmissionEnqListgetAdmissionEnqListt11111111111111111111111111', getAdmissionEnqList);
            ...
            <div className='space-y-4'>
              ...
              <div className='bg-white border border-slate-300'>
                <div className='p-4 border-b border-slate-300'>
                  <h1 className='text-xl font-normal'>Addmission Enquiry</h1>
                </div>
                <div className='p-8'>
                  <div className='grid grid-cols-4 gap-4'>
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Date of Enquiry</label>
                    ...
                    <table className="min-w-full text-left bg-white border border-collapse border-slate-300">
                      <thead className="">
                        <tr className="text-left border border-slate-300">
                          ...
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">contactNo</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">alternateNo</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">enquirySource</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">enquiryType</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">fguardian</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">frelation</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">sguardian</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">srelation</th>
                        </tr>
                      </thead>
                      <tbody>
                        {
                          getAdmissionEnqList && getAdmissionEnqList.length > 0 ?
                            getAdmissionEnqList.map((element, index) => (
                              <>
                                <tr className="border border-slate-300">
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black uppercase bg-white whitespace-nowrap">1</td>
                                  {/* <td className="px-4 py-3 font-serif text-sm text-left text-black uppercase bg-white whitespace-nowrap">{element && element.student.name ? element.student.name : "-"}</td> */}
                                  ...
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black capitalize bg-white whitespace-nowrap">{element && element.contactNo ? element.contactNo : "-"}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black capitalize bg-white whitespace-nowrap">{element && element.alternateNo ? element.alternateNo : "-"}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black capitalize bg-white whitespace-nowrap">{element && element.enquirySource ? element.enquirySource : "-"}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black capitalize bg-white whitespace-nowrap">{element && element.enquiryType ? element.enquiryType : "-"}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black capitalize bg-white whitespace-nowrap">{element && element.fguardian ? element.fguardian : "-"}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black capitalize bg-white whitespace-nowrap">{element && element.frelation ? element.frelation : "-"}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black capitalize bg-white whitespace-nowrap">{element && element.sguardian ? element.sguardian : "-"}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black capitalize bg-white whitespace-nowrap">{element && element.srelation ? element.srelation : "-"}</td>
