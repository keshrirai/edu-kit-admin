...
class Assignment extends Component {
  ...
  assignmentSubmit = (e) => {
    ...
    if (this.handleValidationRole()) {
      let { batch, title, dateOfAssignment, dueDate } = this.state;
      this.props.dispatch(dashboardActions.createAssignment({
        batch: batch,
        title: title,
  ...
  assignmentUpdateSubmit = (e) => {
    e.preventDefault();
    if (this.handleValidationUpdateRole()) {
      let { batch, title, dateOfAssignment, dueDate, id } = this.state.fieldsroleUpdate;
                    ...
                    <div className='border border-slate-300 bg-white'>
                      <form autoComplete="off">
                        ...
                        <div className='w-full px-5 pb-4'>
                          <button className='py-2 px-4 bg-sky-500 text-white rounded-sm text-sm' type="button" onClick={this.assignmentUpdateSubmit} data-config-id="01_primary-action">Save</button>
                        </div>
                  ...
                  <>
                    <div className='border border-slate-300 bg-white'>
                      ...
                      <form autoComplete="off">
                        ...
                        <div className='w-full px-5 pb-4'>
                          <button className='py-2 px-4 bg-sky-500 text-white rounded-sm text-sm' type="button" onClick={this.assignmentSubmit} data-config-id="01_primary-action">Save</button>
                        </div>
