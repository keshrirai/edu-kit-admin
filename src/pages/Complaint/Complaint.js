...
class Complaint extends Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(dashboardActions.getComplaintList(data));
  }
  ...
  deleteUser = (data) => {
    ...
    confirmAlert({
      ...
      buttons: [
        {
          label: 'Yes',
          onClick: () => this.props.dispatch(dashboardActions.deleteComplaint(datatemp))
        },
        {
          label: 'No'
        }
  ...
  render() {
    ...
    let { loading, getCourseList, getAllDepartment, getComplaintList } = dashboard;

    console.log('getComplaintListgetComplaintListgetComplaintListgetComplaintList', getComplaintList);
            ...
            <div className='space-y-4'>
              ...
              <div className='bg-white border border-slate-300'>
                <div className='p-4 border-b border-slate-300'>
                  <h1 className='text-xl font-normal'>Add New Complaint</h1>
                </div>
                <div className='p-8'>
                  <div className='grid grid-cols-4 gap-4'>
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Complaint Type</label>
                    ...
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Date of Complaint</label>
                    ...
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Complainant Name</label>
                    ...
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Complainant Contact Number</label>
                    ...
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Complainant Address</label>
                    ...
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Assign To</label>
                      <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourseUpdate["attendtype"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                        name="attendtype"
                        value={this.state.fieldsCourseUpdate && this.state.fieldsCourseUpdate.attendtype ? this.state.fieldsCourseUpdate.attendtype : ""}
                        onChange={this.inputChangeUpdate} placeholder='Enter Maximum Attendance Percentage' type="text" />
                  ...
                  <div className='flex justify-end w-full px-5 pt-3'>
                    <button type='button' className='px-6 py-2 text-sm text-white rounded-sm bg-sky-500' onClick={this.courseUpdateSubmit}>Save</button>
                  </div>
                </div>
              </div>
                    ...
                    <table className="min-w-full text-left bg-white border border-collapse border-slate-300">
                      <thead className="">
                        <tr className="text-left border border-slate-300">
                          ...
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">complainantName</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">complainantNumber</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">complaintType</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">complainantAddress</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">description</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">actions</th>
                        </tr>
                      </thead>
                      <tbody>
                        {
                          getComplaintList && getComplaintList.length > 0 ?
                            getComplaintList.map((element, index) => (
                              <>
                                <tr className="border border-slate-300">
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black uppercase bg-white whitespace-nowrap">1</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black uppercase bg-white whitespace-nowrap">{element && element.complainantName ? element.complainantName : "-"}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black uppercase bg-white whitespace-nowrap">{element && element.complainantNumber ? element.complainantNumber : "-"}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black uppercase bg-white whitespace-nowrap">{element && element.complaintType ? element.complaintType : "-"}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black uppercase bg-white whitespace-nowrap">{element && element.complainantAddress ? element.complainantAddress : "-"}</td>
