...
class GatePass extends Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(dashboardActions.getGatePassList(data));
  }
  ...
  deleteUser = (data) => {
    ...
    confirmAlert({
      ...
      buttons: [
        {
          label: 'Yes',
          onClick: () => this.props.dispatch(dashboardActions.deleteGatePass(datatemp))
        },
        {
          label: 'No'
        }
  ...
  render() {
    ...
    let { loading, getGatePassList, getAllDepartment } = dashboard;
            ...
            <div className='space-y-4'>
              ...
              <div className='bg-white border border-slate-300'>
                <div className='p-4 border-b border-slate-300'>
                  <h1 className='text-xl font-normal'>Add New GatePass</h1>
                </div>
                <div className='p-8'>
                  <div className='grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4'>
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Type Student/Employee</label>
                    ...
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Time</label>
                    ...
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Reason</label>
                    ...
                    <table className="min-w-full text-left bg-white border border-collapse border-slate-300">
                      <thead className="">
                        <tr className="text-left border border-slate-300">
                          ...
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">reason</th>
                          <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">time</th>
                      ...
                      <tbody>
                        {
                          getGatePassList && getGatePassList.length > 0 ?
                            getGatePassList.map((element, index) => (
                              <>
                                <tr className="border border-slate-300">
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black uppercase bg-white whitespace-nowrap">{index}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black uppercase bg-white whitespace-nowrap">{element && element.reason ? element.reason : "-"}</td>
                                  <td className="px-4 py-3 font-serif text-sm text-left text-black uppercase bg-white whitespace-nowrap">{element && element.time ? element.time : "-"}</td>
...
export default connect(mapStateToProps)(GatePass);