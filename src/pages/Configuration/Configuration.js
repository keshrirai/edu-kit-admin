          ...
          <section>
            ...
            <div className='bg-white border border-slate-300'>
              <div className='p-4 border-b border-slate-300'>
                <h1 className='text-xl font-normal'>Create Configuration</h1>
              </div>
              <div className='p-8'>
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2'>

                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Insitute Name</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["examCode"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      ...
                      onChange={this.inputChange} placeholder='Enter Insitute Name' type="text" />
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Insitute Running Body</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["examName"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      ...
                      onChange={this.inputChange} placeholder='Enter Insitute Running Body' type="text" />
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Insitute Foundation Date</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["examType"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      ...
                      onChange={this.inputChange} placeholder='Enter Insitute Foundation Date' type="text" />
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Insitute Recognition Body</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["description"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      ...
                      onChange={this.inputChange} placeholder='Enter Insitute Recognition Body' type="text" />
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Insitute Recognition Number</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["roomNo"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      ...
                      onChange={this.inputChange} placeholder='Enter Insitute Recognition Number' type="text" />
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Address Line 1</label>
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Address Line 2</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>City </label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>state</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>ZipCode</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                      onChange={this.inputChange} placeholder='Enter ZipCode' type="text" />
                    {this.state.errorsExam["invigilator"] ?
                      <div className="text-yellow-600 invalid-feedback">
                        {this.state.errorsExam["invigilator"]}
                      </div>
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Country</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Email</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Website</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                      onChange={this.inputChange} placeholder='Enter Website' type="text" />
                    {this.state.errorsExam["invigilator"] ?
                      <div className="text-yellow-600 invalid-feedback">
                        {this.state.errorsExam["invigilator"]}
                      </div>
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Fax</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                      onChange={this.inputChange} placeholder='Enter Fax' type="text" />
                    {this.state.errorsExam["invigilator"] ?
                      <div className="text-yellow-600 invalid-feedback">
                        {this.state.errorsExam["invigilator"]}
                      </div>
                  ...
                  <table className="min-w-full text-left bg-white border border-collapse border-slate-300">
                    <thead className="">
                      <tr className="text-left border border-slate-300">
                        ...
                        <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">Configuration Author</th>
                        <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">Configuration Language</th>
                        <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">Configuration Topic</th>
                        <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">Configuration Publisher</th>
                        ...
                        <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">Price Of Configuration</th>
