            ...
            <div className='space-y-4'>
              ...
              <div className='border border-slate-300 bg-white'>
                <div className='border-b border-slate-300 p-4'>
                  <h1 className='text-xl font-normal'>Send Email</h1>
                </div>
                <div className='p-8'>
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                    ...
                    <div>
                      ...
                      <textarea className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourseUpdate["tWDays"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                        name="tWDays"
                        value={this.state.fieldsCourseUpdate && this.state.fieldsCourseUpdate.tWDays ? this.state.fieldsCourseUpdate.tWDays : ""}
                        onChange={this.inputChangeUpdate} placeholder='Email' type="text" />
                    ...
                    <div>
                      ...
                      <textarea className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourseUpdate["minAttendPer"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                        name="minAttendPer"
                    ...
                    <div>
                      ...
                      <textarea className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourseUpdate["attendtype"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                        name="attendtype"
                    ...
                    <div className='w-full px-5'>
                      <button type='button' className='py-2 px-4 bg-sky-500 text-white rounded-sm text-sm' onClick={this.courseUpdateSubmit}>Submit</button>
                    </div>
                  </div>
                </div>
              </div>
