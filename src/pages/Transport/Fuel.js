          ...
          <section>
            ...
            <div className='bg-white border border-slate-300'>
              <div className='p-4 border-b border-slate-300'>
                <h1 className='text-xl font-normal'>Add New Fuel Record</h1>
              </div>
              <div className='p-8'>
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2'>
                  ...
                  <div>
                    ...
                    <div className='relative flex items-center w-full py-2 text-gray-800 bg-white border rounded-sm appearance-none cursor-pointer md:w-auto'>
                      <select className="w-full px-4 text-sm font-normal text-gray-700 bg-white appearance-none focus:outline-none" onChange={this.inputChange}
                        name="courseId">
                        <option>Bus No 1 (1524)</option>
                        <option>Bus No 2 (1526)</option>
                        <option>Bus No 3 (1527)</option>
                        <option>Bus No 4 (1528)</option>
                        <option>Bus No 5 (1529)</option>
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Quantity</label>
                    <input className="w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500" placeholder='Enter Quantity' type="text" />
                  </div>

                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Price/Unit</label>
                    <input className="w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500" placeholder='Enter Price/Unit' type="text" />
                  </div>

                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Date of Fueling</label>
                    <input className="w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500" placeholder='Enter Date of Fueling' type="date" />
                  </div>

                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Log</label>
                    <input className="w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500" placeholder='Enter Log' type="text" />
                  </div>
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Description</label>
                    <input className="w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500" placeholder='Enter Description' type="text" />
                  </div>
                </div>
              </div>
              <div className='flex justify-end w-full px-5 pb-4'>
                <button className='px-4 py-2 text-sm text-white rounded-sm bg-sky-500 hover:bg-sky-600' type="button" onClick={this.examSubmit} data-config-id="01_primary-action">Save</button>
              </div>
            </div>
          </section>
        </div>
