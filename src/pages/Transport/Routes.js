...
class Routes extends Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(dashboardActions.getRouteList(data));
  ...
  deleteUser = (data) => {
    ...
    confirmAlert({
      ...
      buttons: [
        {
          label: 'Yes',
          onClick: () => this.props.dispatch(dashboardActions.deleteRoute(datatemp))
        },
        {
          label: 'No'
        }
  ...
  render() {
    ...
    let { getRouteList, getAllCourse } = dashboard;

    console.log('getRouteListgetRouteListgetRouteListgetRouteListgetRouteList', getRouteList);
          ...
          <section>
            ...
            <div className='bg-white border border-slate-300'>
              <div className='p-4 border-b border-slate-300'>
                <h1 className='text-xl font-normal'>Add New Route</h1>
              </div>
              <div className='p-8'>
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2'>
                  ...
                  <div>
                    <label class=' text-sm font-normal text-gray-600 pb-4'>Stoppage</label>
                ...
                <div className="overflow-hidden ">
                  <table className="min-w-full text-left bg-white border border-collapse border-slate-300">
                    ...
                    <tbody className='divide-y' >
                      ...
                      {
                        getRouteList && getRouteList.length > 0 ?
                          getRouteList.map((element, index) => (
                            <>
