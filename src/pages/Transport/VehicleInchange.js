          ...
          <section>
            ...
            <div className='bg-white border border-slate-300'>
              <div className='p-4 border-b border-slate-300'>
                <h1 className='text-xl font-normal'>Vehicle Inchange</h1>
              </div>

              <div className="px-4 py-4 space-y-6">
                <h2 className="flex text-gray-600">Bus No 1 JBS 1524<span className="pl-4 mt-0.5"><FiEdit /></span></h2>
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2'>
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>VehicleInchange Author</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["examName"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      ...
                      onChange={this.inputChange} placeholder='Enter VehicleInchange Author' type="text" />
                  ...
                  <div className='flex justify-end w-full px-5 mt-6'>
                    <button className='px-6 py-1 text-sm text-white rounded-sm bg-sky-500' type="button" onClick={this.examSubmit} data-config-id="01_primary-action">Save</button>
                  </div>
                </div>
                <h2 className="flex text-gray-600">Bus No 1 JBS 1524<span className="pl-4 mt-0.5"><FiEdit /></span></h2>
                <h2 className="flex text-gray-600">Bus No 1 JBS 1524<span className="pl-4 mt-0.5"><FiEdit /></span></h2>
