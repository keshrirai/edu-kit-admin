...

              {
                this.state.updateShow ?
                  <>
                    <div className='border border-slate-300 bg-white'>
                      <div className='border-b border-slate-300 p-4'>
                        <h1 className='text-xl font-normal'>Update Course</h1>
                      </div>
                      <div className='p-8'>
                        <div className='space-y-6'>
                          <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Course Code</label>
                          ...
                          <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Course Description</label>
                          ...
                          <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Total Working Days</label>
                          ...
                          <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Maximum Attendance Percentage</label>
                          ...
                          <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Attendance Percentage</label>
                          ...
                          <div className='w-full px-5'>
                            <button type='button' className='py-2 px-4 bg-sky-500 text-white rounded-sm text-sm' onClick={this.courseUpdateSubmit}>Save111</button>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <>
                    <div className='border border-slate-300 bg-white'>
                      <div className='border-b border-slate-300 p-4'>
                        <h1 className='text-xl font-normal'>Add Course</h1>
                      </div>
                      <div className='p-8'>
                        <div className='space-y-6'>
                          <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Course Code</label>
                            <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourse["cCode"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                              name="cCode"
                              value={this.state.fieldsCourse["cCode"] ? this.state.fieldsCourse["cCode"] : ''}
                              onChange={this.inputChange} placeholder='Enter Code' type="text" />
                            {this.state.errorsCourse["cCode"] ?
                              <div className="invalid-feedback  text-yellow-600">
                                {this.state.errorsCourse["cCode"]}
                              </div>
                              : null}
                          ...
                          <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Course Name</label>
                            <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourse["cName"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                              name="cName"
                              value={this.state.fieldsCourse["cName"] ? this.state.fieldsCourse["cName"] : ''}
                              onChange={this.inputChange} placeholder='Enter Course Name' type="text" />
                            {this.state.errorsCourse["cName"] ?
                              <div className="invalid-feedback  text-yellow-600">
                                {this.state.errorsCourse["cName"]}
                              </div>
                              : null}
                          ...
                          <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Course Description</label>
                            <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourse["desc"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                              name="desc"
                              value={this.state.fieldsCourse["desc"] ? this.state.fieldsCourse["desc"] : ''}
                              onChange={this.inputChange} placeholder='Enter Course Description' type="text" />
                            {this.state.errorsCourse["desc"] ?
                              <div className="invalid-feedback  text-yellow-600">
                                {this.state.errorsCourse["desc"]}
                              </div>
                              : null}
                          ...
                          <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Total Working Days</label>
                            <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourse["tWDays"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                              name="tWDays"
                              value={this.state.fieldsCourse["tWDays"] ? this.state.fieldsCourse["tWDays"] : ''}
                              onChange={this.inputChange} placeholder='Enter Total Working Days' type="text" />
                            {this.state.errorsCourse["tWDays"] ?
                              <div className="invalid-feedback  text-yellow-600">
                                {this.state.errorsCourse["tWDays"]}
                              </div>
                              : null}
                          ...
                          {/* <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Syllabus Name</label>
                            <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourse["syllabusName"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                              name="syllabusName"
                              value={this.state.fieldsCourse["syllabusName"] ? this.state.fieldsCourse["syllabusName"] : ''}
                              onChange={this.inputChange} placeholder='Enter Total Working Days' type="text" />
                            {this.state.errorsCourse["syllabusName"] ?
                              <div className="invalid-feedback  text-yellow-600">
                                {this.state.errorsCourse["syllabusName"]}
                              </div>
                              : null}
                          ...
                          <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Minimum Attendance Percentage</label>
                            <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourse["minAttendPer"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                              name="minAttendPer"
                              value={this.state.fieldsCourse["minAttendPer"] ? this.state.fieldsCourse["minAttendPer"] : ''}
                              onChange={this.inputChange} placeholder='Enter Minimum Attendance Percentage' type="text" />
                            {this.state.errorsCourse["minAttendPer"] ?
                              <div className="invalid-feedback  text-yellow-600">
                                {this.state.errorsCourse["minAttendPer"]}
                              </div>
                              : null}
                          ...
                          <div>
                            <label class='text-sm font-normal text-gray-600 pb-4'>Attendance Percentage</label>
                            <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourse["attendtype"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                              name="attendtype"
                              value={this.state.fieldsCourse["attendtype"] ? this.state.fieldsCourse["attendtype"] : ''}
                              onChange={this.inputChange} placeholder='Enter Maximum Attendance Percentage' type="text" />
                            {this.state.errorsCourse["attendtype"] ?
                              <div className="invalid-feedback  text-yellow-600">
                                {this.state.errorsCourse["attendtype"]}
                              </div>
                              : null}
                          ...
                          <div className='w-full px-5'>
                            <button type='button' className='py-2 px-4 bg-sky-500 text-white rounded-sm text-sm' onClick={this.courseSubmit}>Save111</button>
                          </div>
                        </div>
                      </div>
                    </div>
