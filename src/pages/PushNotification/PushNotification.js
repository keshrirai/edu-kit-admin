            ...
            <div className='space-y-4'>
              ...
              <div className='border border-slate-300 bg-white'>
                <div className='border-b border-slate-300 p-4'>
                  <h1 className='text-xl font-normal'>Send Push Notification</h1>
                </div>
                <div className='p-8'>
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                    ...
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Body</label>
                    ...
                    <div>
                      <input type="checkbox" />
                      <label class='text-sm font-normal text-gray-600'>Send to Admin</label>
                    </div>
                    ...
                    <table className="min-w-full text-left border border-slate-300 border-collapse bg-white">
                      <thead className="">
                        <tr className="text-left border border-slate-300">
                          ...
                          <th scope="col" className="px-4 p3 text-left text-sm capitalize font-medium text-gray-600 whitespace-nowrap">Minimum Attendance(%)</th>
