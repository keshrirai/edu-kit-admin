...
class AdmissionEnquiry extends Component {
  ...
  componentDidMount() {
    ...
    this.props.dispatch(dashboardActions.getMeetingList(data));
  }
  ...
  render() {
    ...
    let { loading, getCourseList, getAllDepartment, getMeetingList } = dashboard;

    console.log('getMeetingListgetMeetingListgetMeetingListgetMeetingList', getMeetingList);
            ...
            <div className='space-y-4'>
              ...
              <div className='bg-white border border-slate-300'>
                <div className='p-4 border-b border-slate-300'>
                  <h1 className='text-xl font-normal'>Add Meeting</h1>
                </div>
                  ...
                  <div className='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4'>
                    <div>
                      ...
                      <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourseUpdate["cCode"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                        ...
                        onChange={this.inputChangeUpdate} placeholder='Title' type="text" />
                    ...
                    <div>
                      ...
                      <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourseUpdate["cName"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                        ...
                        onChange={this.inputChangeUpdate} placeholder='Date' type="date" />
                    ...
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>Start Time</label>
                      <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsCourseUpdate["desc"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                        ...
                        onChange={this.inputChangeUpdate} type="date" />
                    ...
                    <div>
                      <label class='text-sm font-normal text-gray-600 pb-4'>End Time</label>
                    ...
                    <div className='mt-6'>
                      <label class="w-48 flex items-center px-2 py-2 bg-sky-500 text-white rounded-sm shadow-lg tracking-wide cursor-pointer hover:bg-blue-400 hover:text-white duration-300 space-x-1">
                        <svg className='w-6 h-6' viewBox="0 0 24 24">
                          <path fill="currentColor" d="M9,16V10H5L12,3L19,10H15V16H9M5,20V18H19V20H5Z" />
                        </svg>
                        <span class="text-base leading-normal">Upload Document</span>
                        <input type='file' class="hidden" />
                      </label></div>
                    <div className='flex mt-6'>
                      <div className='w-full px-5'>
                        <button type='button' className='px-4 py-2 text-sm text-white bg-red-500 rounded-sm'>Cancel</button>
                      </div>
                      <div className='w-full px-5'>
                ...
                <div className="inline-block min-w-full">
                  <div className="overflow-x-hidden">
                    <table className="min-w-full text-left bg-white border border-collapse border-slate-300">
                      ...
                      <tbody>
                        {
                          getMeetingList && getMeetingList.length > 0 ?
                            getMeetingList.map((element, index) => (
                              <>
