...
class FeeAllocation extends Component {
          ...
          <section>
            ...
            <div className='bg-white border border-slate-300'>
              <div className='p-4 border-b border-slate-300'>
                <h1 className='text-xl font-normal'>Create Book</h1>
              </div>
              <div className='p-8'>
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2'>
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Book Author</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["examName"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      ...
                      onChange={this.inputChange} placeholder='Enter Book Author' type="text" />
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Book Language</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["examType"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      ...
                      onChange={this.inputChange} placeholder='Enter Book Language' type="text" />
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Book Topic</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["description"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      ...
                      onChange={this.inputChange} placeholder='Enter Book Topic' type="text" />
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Book Publisher</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["roomNo"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      ...
                      onChange={this.inputChange} placeholder='Enter Book Publisher' type="text" />
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>ISBN Number</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      ...
                      onChange={this.inputChange} placeholder='Enter ISBN Number' type="text" />
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Edition</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                      onChange={this.inputChange} placeholder='Enter Edition' type="text" />
                    {this.state.errorsExam["invigilator"] ?
                      <div className="text-yellow-600 invalid-feedback">
                        {this.state.errorsExam["invigilator"]}
                      </div>
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>No of Pages </label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                      onChange={this.inputChange} placeholder='Enter No of Pages' type="text" />
                    {this.state.errorsExam["invigilator"] ?
                      <div className="text-yellow-600 invalid-feedback">
                        {this.state.errorsExam["invigilator"]}
                      </div>
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Price of Book</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                      onChange={this.inputChange} placeholder='Enter Price of Book' type="text" />
                    {this.state.errorsExam["invigilator"] ?
                      <div className="text-yellow-600 invalid-feedback">
                        {this.state.errorsExam["invigilator"]}
                      </div>
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Summary</label>
                    <input className={`w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500 ${!this.state.errorsExam["invigilator"] ? "'border-opacity-20 " : "order-opacity-100 border-red-500 bg-red-100"}`}
                      name="invigilator"
                      value={this.state.fieldsExam["invigilator"] ? this.state.fieldsExam["invigilator"] : ''}
                      onChange={this.inputChange} placeholder='Enter Summary' type="text" />
                    {this.state.errorsExam["invigilator"] ?
                      <div className="text-yellow-600 invalid-feedback">
                        {this.state.errorsExam["invigilator"]}
                      </div>
                  ...
                  <table className="min-w-full text-left bg-white border border-collapse border-slate-300">
                    <thead className="">
                      <tr className="text-left border border-slate-300">
                        ...
                        <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">Book Author</th>
                        <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">Book Language</th>
                        <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">Book Topic</th>
                        <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">Book Publisher</th>
                        ...
                        <th scope="col" className="px-4 py-3 text-sm font-medium text-left text-gray-600 capitalize whitespace-nowrap">Price Of Book</th>
...
export default connect(mapStateToProps)(FeeAllocation);