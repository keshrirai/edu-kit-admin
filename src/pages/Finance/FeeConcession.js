          ...
          <section>
            ...
            <div className='bg-white border border-slate-300'>
              <div className='p-4 border-b border-slate-300'>
                <h1 className='text-xl font-normal'>Add New Fee Fee Concession</h1>
              </div>
              <div className='p-8'>
            ...
            <div className='bg-white border border-slate-300'>
              <div className='p-8 space-y-3'>
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2'>
                  <div>
                    <h1 className="pt-8 text-gray-700">Admission Fee (School Fee)</h1>
                  </div>
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Name</label>
                    <input className="w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500" placeholder='Enter Name' type="text" />
                ...
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2'>
                  <div>
                    <h1 className="pt-8 text-gray-700">Tuition Fee (School Fee)</h1>
                  </div>
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Name</label>
                    <input className="w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500" placeholder='Enter Name' type="text" />
                ...
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2'>
                  <div>
                    <h1 className="pt-8 text-gray-700">Annual Charges (School Fee)</h1>
                  </div>
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Name</label>
                    <input className="w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500" placeholder='Enter Name' type="text" />
                ...
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2'>
                  <div>
                    <h1 className="pt-8 text-gray-700">Mess Fee (Mess Fee)</h1>
                  </div>
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Name</label>
                    <input className="w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500" placeholder='Enter Name' type="text" />
                ...
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2'>
                  <div>
                    <h1 className="pt-8 text-gray-700">Book Fee (Book & Uniform Fee)</h1>
                  </div>
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Name</label>
                    <input className="w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500" placeholder='Enter Name' type="text" />
...
export default connect(mapStateToProps)(FeeConcession);