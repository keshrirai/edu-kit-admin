          ...
          <section>
            ...
            <div className='bg-white border border-slate-300'>
              <div className='p-4 border-b border-slate-300'>
                <h1 className='text-xl font-normal'>Add New Income</h1>
              </div>
              <div className='p-8'>
                <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 md:grid-cols-2'>
                  ...
                  <div>
                    <label class='text-sm font-normal text-gray-600 pb-4 capitalize'>Date of Income</label>
                    <input className="w-full border px-4 py-1.5 rounded-xs focus:outline-none text-base text-gray-700 placeholder-gray-500" placeholder='Enter Date of Income' type="text" />
                  </div>
